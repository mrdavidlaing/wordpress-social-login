<p style="margin:10px;font-size: 14px;"> 
	This plugin allow your visitors to login and comment using their accounts on Facebook, Google, Yahoo, Twitter, Windows Live, Myspace, Foursquare, Linkedin, Gowalla, Last.fm, Tumblr and AOL. 
</p>
 
<br />

<h3 style="border-bottom: 1px solid #CCCCCC;margin:10px;">Important to know</h3> 
<p style="margin-left:25px;margin:10px;font-size: 13px;"> 
	Well, it's quite a story, please bear with me :
</p>
<ul style="list-style:circle inside;margin-left:25px;font-size: 13px;">
...
<span style="color:red">*</span> <a href="http://en.wikipedia.org/wiki/Software_release_life_cycle#Alpha">http://en.wikipedia.org/wiki/Software_release_life_cycle#Alpha</a>